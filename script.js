/* Tailwind Config for VKT Logistics */
tailwind.config = {
    darkMode: "class",
    theme: {
        extend: {
...
window.trackShipment = function(event) {
    ...
    if (trackingId.includes('DELIVERED') || trackingId === 'VKT-1001') {
        status = 'Delivered';
        currentStep = 3;
    ...
    } else if (trackingId.includes('BOOKED') || trackingId === 'VKT-1003') {
        ...
        eta = 'May 26, 2026';
    } else if (trackingId.includes('DISPATCHED') || trackingId === 'VKT-1002') {
        status = 'Dispatched';
        currentStep = 1;
